      ...
      >
        ...
        {image && (
          <>
            ...
            <img className="blur soft" src={image} alt="" aria-hidden="true" loading="lazy" decoding="async" />
            <img className="blur deep" src={image} alt="" aria-hidden="true" loading="lazy" decoding="async" />
          </>
        )}
      </span>
